...
@Component({
  selector: 'app-cattle-feed-plant-indent',
  templateUrl: './cattle-feed-plant-indent.component.html',
  styleUrls: ['./cattle-feed-plant-indent.component.scss']
})
export class CattleFeedPlantIndentComponent implements OnInit {
  ...
  displayedColumns: string[] = ["slno","date" ,"plantName", "packetName","bag","fulfilledDate","orderStatus"];
  // customerList;
  // pourerTypes:
  ...
  ngOnInit() {
    ...
    this.previousOrderedIndent=[
     { slno:1,date:'01-11-22' ,plantName:'Plant 1', packetName:'By-pass Cattle Feed',bag:'10',fulfilledDate:'03-11-22',orderStatus:'FulFilled Completed'},
     { slno:2,date:'04-11-22' ,plantName:'Plant 1', packetName:'Nandini Gold (Formely type-1) Cattle Feed',bag:'10',fulfilledDate:'05-11-22',orderStatus:'FulFilled Completed'},
    //  { slno:1,date:'06-11-22' ,plantName:'Plant 1', packetName:'Calf Feed',bag:'10',fulfilledDate:'08-11-22',orderStatus:'FulFilled Completed'},
     { slno:3,date:'17-11-22' ,plantName:'Plant 1', packetName:'Bull Feed',bag:'10',fulfilledDate:'',orderStatus:'Partially fulfilled'},
