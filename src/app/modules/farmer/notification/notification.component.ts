...
export class NotificationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.notification=[
      {
        date:'01-03-23',
        name:'Low SNF% detected',
        description:'7.9 % SNF perecentage detected on 01-10-22 Morning'
      },
      {
        date:'15-03-23',
        name:'Payment Credit',
        description:'balance amount has been Credited'
      },
      {
        date:'16-03-23',
        name:'Stock Arrival',
        description:'Nandini Gold stock has been arrived'
      },
    ]
    this.mpcsList = [
      {
