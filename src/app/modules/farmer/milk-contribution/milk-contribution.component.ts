...
@Component({
  selector: 'app-milk-contribution',
  templateUrl: './milk-contribution.component.html',
  styleUrls: ['./milk-contribution.component.scss']
})
export class MilkContributionComponent implements OnInit {
  ...
  dateRange(fromDate, toDate) {
    this.dailyCollectionDetails=[];
    this.displayedColumns= ["date","morning", "evening"];
    ...
    const endDate = toDate.split("-");
      for (let i = startDate[0]; i <= endDate[0]; i++) {
        ...
        this.dailyCollectionDetails.push({date:date,morning:2.5,evening:2.5});
