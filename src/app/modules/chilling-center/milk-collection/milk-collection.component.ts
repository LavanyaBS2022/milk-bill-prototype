...
export class MilkCollectionComponent implements OnInit {
  ...
  displayedColumns: string[] = ["SlNo", "Name", "Batch","Action"];
  // customerList;
  // porerTypes:
  selectedMpcs;
  monthDays: string[];
  ...
  dateRange(fromDate, toDate) {
    this.dailyCollectionDetails=[];
    this.displayedColumns = ["SlNo", "Name", "Batch","Action"]
